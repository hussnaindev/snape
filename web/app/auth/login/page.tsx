            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="hidden lg:block lg:w-[280px] lg:flex-none p-8 border-r border-white/10 bg-gradient-to-b from-white/[0.06] to-transparent">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center flex-none">
                    <Logo className="w-5 h-5 text-white/85" />
                  </div>
                  <div>
                ...
                <div className="mt-7 space-y-3">
                  ...
                  <div className="flex items-start gap-2.5">
                    <DotIcon />
                    <p className="text-white/55 text-sm leading-snug">Secure sign-in in seconds.</p>
                  </div>
                </div>

                <div className="mt-8 pt-6 border-t border-white/10">
                  <p className="text-white/40 text-xs">New here?</p>
                  <Link
                    href="/auth/signup"
                    className="mt-2 inline-flex items-center justify-center w-full rounded-lg border border-white/15 bg-white/[0.02] px-3 py-2 text-sm font-semibold text-white/85 hover:border-white/30 hover:bg-white/[0.04] transition-colors"
                  >
                    Create an account
                  </Link>
                </div>
              ...
              <div className="flex-1 p-8 py-10">
                ...
                <div className="flex items-center gap-3 mb-1">
                  <div className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center flex-none lg:hidden">
...
function DotIcon() {
  return <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-white/25 flex-none" aria-hidden />;
}
