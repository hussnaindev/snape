...
import { DownloadsIndicator } from '@/components/downloads-indicator';
    ...
    >
      ...
      <div className="relative h-16 flex items-center justify-between px-4 md:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Player controls — shown when inline player is active */}
          {controls && (
            <>
              {controls.onEpisodes && (
                <button
                  type="button"
                  onClick={controls.onEpisodes}
              ...
              <button
                type="button"
                onClick={controls.onFullscreen}
                aria-label={controls.isFullscreen ? 'Exit fullscreen' : 'Full screen'}
