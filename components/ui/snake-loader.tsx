    ...
    >
      ...
      >
        ...
        <circle
          ...
          style={{ filter: 'drop-shadow(0 0 5px rgba(168,213,181,0.7))' }}
        />
      </svg>

      {/* Logo — static, centered, with subtle glow */}
      <Logo
        className="relative text-sage"
        style={{
          width: logoSize,
          height: logoSize,
          filter: 'drop-shadow(0 0 6px rgba(168,213,181,0.5))',
        }}
      />
    </div>
  );
