...
export const PREFERRED_PROVIDERS: ReadonlyArray<{
  ...
  { key: 'netflix', label: 'Netflix', assetPath: '/providers/netflix.svg' },
  { key: 'primevideo', label: 'Prime Video', assetPath: '/providers/primevideo.svg' },
  { key: 'paramountplus', label: 'Paramount+', assetPath: '/providers/paramountplus.svg' },
  { key: 'appletv', label: 'Apple TV+', assetPath: '/providers/appletv.svg' },
  { key: 'max', label: 'Max', assetPath: '/providers/max.svg' },
  { key: 'disneyplus', label: 'Disney+', assetPath: '/providers/disneyplus.svg' },
] as const;
